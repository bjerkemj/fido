                ...
                <View className="px-6 py-6">
                    ...
                    <View className="bg-green-50 rounded-xl p-4 mb-6 border-l-4 border-green-400">
                        ...
                        <Text className="text-green-700 text-sm leading-5">
                            Your privacy matters. All your data stays on your device - we don't collect, store, or transmit any of your personal information or preferences.
                        </Text>
                    </View>
                    ...
                    <Section title="Our Commitment to Your Privacy">
                        <Paragraph>
                            Fido ("we," "our," or "the App") is committed to protecting your privacy. This Privacy Policy explains how we handle information when you use our mobile application.
                        </Paragraph>
                    </Section>
                    ...
                    <Section title="Local Storage Only">
                        <Paragraph>
                            All of your preferences (which dogs you've liked or disliked) are stored locally on your device using AsyncStorage. This means:
                        </Paragraph>
                    ...
                    <Section title="Third-Party Image Services">
                        <Paragraph>
                            Dog breed images displayed in the App are loaded from third-party services including Unsplash, Pixabay, Flickr, Pexels, and Wikipedia. When you view these images:
                        </Paragraph>
                        <BulletPoint>Images are loaded directly from their servers</BulletPoint>
                        <BulletPoint>These services may collect basic usage data (like IP addresses) as per their own privacy policies</BulletPoint>
                        <BulletPoint>We do not control or have access to any data these services may collect</BulletPoint>
                    </Section>
                    ...
                    <Section title="No Accounts Required">
                        <Paragraph>
                            Fido does not require you to create an account, log in, or provide any personal information to use the app. You can start exploring dog breeds immediately without sharing any details about yourself.
                        </Paragraph>
                    </Section>
                    ...
                    <Section title="Data Security">
                        <Paragraph>
                            Since all your data is stored locally on your device and never transmitted to our servers, the security of your data is primarily dependent on your device's security. We recommend:
                        </Paragraph>
                    ...
                    <Section title="Changes to This Privacy Policy">
                        ...
                        <Paragraph style={{ marginTop: 12 }}>
                            If we ever change our practices regarding data collection, we will notify users through the app and obtain consent where required by law.
                        </Paragraph>
                    </Section>
